CREATE OR REPLACE VIEW informacoes_livros AS -- FUNCIONA, ver todos os dados de um livro, incluindo autor e editora, mais a quantidade de emprestimo e vendas globalmente
